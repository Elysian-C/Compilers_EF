...
static std::unique_ptr<ExprAST> ParseIfExpr() {
  ...
  if (CurTok != tok_else)
    return LogError("expected 'else' after 'then' expression");
...
Value *IfExprAST::codegen() {
  ...
  ThenBB = Builder->GetInsertBlock();  // Update ThenBB, it may change
  ...
  if (!ElseV)
    return nullptr;
  Builder->CreateBr(MergeBB);
  ElseBB = Builder->GetInsertBlock();  // Update ElseBB, it may change
